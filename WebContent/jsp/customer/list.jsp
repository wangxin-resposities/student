...
<script type="text/javascript">
	$(function(){
		$.post("${pageContext.request.contextPath }/baseDict_findByTypeCode.action",{"dict_type_code":"002"},function(data){
			...
			$("#cust_source option[value='${cust_source.dict_id}']").attr('selected','selected')
		},"json");
		$.post("${pageContext.request.contextPath }/baseDict_findByTypeCode.action",{"dict_type_code":"006"},function(data){
			...
			$("#cust_level option[value='${cust_level.dict_id}']").attr('selected','selected')
		},"json");
		$.post("${pageContext.request.contextPath }/baseDict_findByTypeCode.action",{"dict_type_code":"001"},function(data){
			...
			$("#cust_industry option[value='${cust_industry.dict_id}']").attr('selected','selected')
		},"json");
	})
</script>
									...
									<TD><SPAN id=pagelink>
											<DIV
												...
												<s:iterator var="i" begin="1" end="totalPage">
													...
													<s:else>
														<a href="javascript:to_page(<s:property value="#i"/>)">${i }</a>
													</s:else>
												</s:iterator>
